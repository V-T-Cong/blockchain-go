...
const (
	...
	NodeService_SubmitVote_FullMethodName      = "/node.NodeService/SubmitVote"
...
type NodeServiceClient interface {
	...
	ProposeBlock(ctx context.Context, in *Block, opts ...grpc.CallOption) (*Ack, error)
	SubmitVote(ctx context.Context, in *Vote, opts ...grpc.CallOption) (*Ack, error)
...
func (c *nodeServiceClient) ProposeBlock(ctx context.Context, in *Block, opts ...grpc.CallOption) (*Ack, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Ack)
...
func (c *nodeServiceClient) SubmitVote(ctx context.Context, in *Vote, opts ...grpc.CallOption) (*Ack, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Ack)
	err := c.cc.Invoke(ctx, NodeService_SubmitVote_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NodeServiceServer interface {
	...
	ProposeBlock(context.Context, *Block) (*Ack, error)
	SubmitVote(context.Context, *Vote) (*Ack, error)
...
func (UnimplementedNodeServiceServer) ProposeBlock(context.Context, *Block) (*Ack, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ProposeBlock not implemented")
}
func (UnimplementedNodeServiceServer) SubmitVote(context.Context, *Vote) (*Ack, error) {
...
func _NodeService_SubmitVote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Vote)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NodeServiceServer).SubmitVote(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NodeService_SubmitVote_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NodeServiceServer).SubmitVote(ctx, req.(*Vote))
	}
	return interceptor(ctx, in, info, handler)
}
...
var NodeService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _NodeService_SubmitVote_Handler,
		},
		{
			MethodName: "GetBlock",
